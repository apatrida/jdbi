...
class QueryHandler extends CustomizingStatementHandler
{
    ...
    QueryHandler(Class<?> sqlObjectType, ResolvedMethod method, ResultReturnThing magic, final FallbackBinderFactory fallbackBinderFactory)
    {
        super(sqlObjectType, method, fallbackBinderFactory);
        this.method = method;
        this.magic = magic;
